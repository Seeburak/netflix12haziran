...
urlpatterns = [
    ...
    path('netflix/filmler', filmler, name='netflix/filmler'),
    path('netflix/diziler', diziler, name='netflix/diziler'),
    path('netflix/filmdizi', filmdizi, name='netflix/filmdizi'),
    path('netflix/profilkim', profilkim, name='netflix/profilkim'),
